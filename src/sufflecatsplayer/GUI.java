...
//                            }
        ...
        new Thread() {
            public void run() {
                jLabelfirst.setSize(w, h);
                jLabelsecond.setSize(w, h);
                jLabelthird.setSize(w, h);
                while (true) {
                    BufferedImage first = r.createScreenCapture(new Rectangle(x, y1, w, h));
                    BufferedImage second = r.createScreenCapture(new Rectangle(x, y2, w, h));
                    BufferedImage third = r.createScreenCapture(new Rectangle(x, y3, w, h));

                    jLabelfirst.setIcon(new ImageIcon(first));
                    jLabelsecond.setIcon(new ImageIcon(second));
                    jLabelthird.setIcon(new ImageIcon(third));
                }
            }
        };//.start();
